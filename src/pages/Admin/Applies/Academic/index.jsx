...
import { getApplies, updateApplyStatus } from '../../../../api/academicApply';
    ...
    <div className='admin-users'>
        <div className="admin-users__title mb-5">
            ...
            <div>
              ...
              <select style={{border: "1px solid #D0D5DD", fontSize: "14px", fontWeight: "400",padding: "5px 16px", borderRadius: "8px", marginLeft: "16px"}}>
                <option value="">Tədrisə görə</option>
                <option value="1">Təsdiqlənmiş</option>
                <option value="2">Gözləmədə</option>
                <option value="3">Silinmiş</option>
              </select>
          ...
          <table className='min-w-full divide-y divide-gray bg-white rounded-2 shadow-md'>
              ...
              <tbody style={{fontSize: "12px"}}>
                  ...
                  <tr className={data.status === 'silinmiş' && 'text-decoration-line-through'} key={data.id}>
                    ...
                    <td className='px-6 py-3 whitespace-nowrap text-sm text-gray border'>{data.course.title}</td>
